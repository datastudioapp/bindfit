...
def run_bindfit(input_file: str, hostname: str, guestname: str, fitter_name: str, method: str, normalise: bool, flavour: str, dilute: bool, params: dict, ridge:bool=False, lam: float=3e-5) -> dict:
    ...
    fitter.run_scipy(params, method=method, ridge=ridge, lam=lam)
